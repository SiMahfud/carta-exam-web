...
import { RefreshCw, CheckCircle2, ExternalLink, ShieldCheck, Database, Layers, ArrowUpRight } from "lucide-react";
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground px-3 py-1.5 rounded-lg border bg-background hover:bg-muted transition-colors"
                        >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-3.5 rounded-xl bg-muted/50 border text-xs">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="font-semibold text-foreground">
                                {lastSyncResult ? `${lastSyncResult.synced_students} siswa tersinkron` : "Siap Ditarik"}
                            </span>
                        </div>
                    </div>
                </div>
